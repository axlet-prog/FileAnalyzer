...
* **Потоковая обработка данных**: В прошлой реализации результаты фильтрации сохранялись в памяти приложения, что могло
  привести к OutOfMemoryError. Теперь же данные записываются немедленно после обработки
